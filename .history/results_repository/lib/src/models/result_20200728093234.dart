...
class Result extends Equatable {
  ...
  static Result fromMap(Map<String, dynamic> map) {
    ...
    return Result(
      ...
      allAnswers: List<Answer>.from(map['allAnswers']?.map((x) => Answer.fromMap(x))),
    );
  }

  @override
  String toString() {
    return 'Result(category: $category, type: $type, difficulty: $difficulty, question: $question, correctAnswer: $correctAnswer, allAnswers: $allAnswers)';
  }
  ...
  bool operator ==(Object o) {
    ...
    return o is Result &&
      ...
      listEquals(o.allAnswers, allAnswers);
  }

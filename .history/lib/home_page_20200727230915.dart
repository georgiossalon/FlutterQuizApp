...
class _HomePageBodyState extends State<HomePageBody> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<QuestionsBloc, ResultsState>(
        listener: (context, state) {
          if (state is ResultsLoadFailure) {
        ...
        child: BlocBuilder<QuestionsBloc, ResultsState>(
          builder: (context, state) {
            ...
            if (state is ResultsInitial) {
              return Center(
                child: RaisedButton(
                  onPressed: () =>
                      context.bloc<QuestionsBloc>().add(ResultsLoaded()),
...
class QuestionList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<QuestionsBloc, ResultsState>(
      builder: (context, state) {
        if (state is ResultsLoadSucess) {
